DROP DATABASE IF EXISTS bigtalk;
CREATE DATABASE bigtalk DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE bigtalk;
...
VALUES(1,'admin','21232f297a57a5a743894a0e4a801fc3',0,0,0);
...
CREATE TABLE `IMUser` (
  ...
  `password` varchar(1024) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '密码',
  ...
  `email` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT 'email',
