...
build() {
    ...
    cp slog/log4cxx.properties ../$build_version/login_server/
    cp slog/libslog.so ../$build_version/login_server/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/login_server/
    cp monitor.sh ../$build_version/login_server/

    cp route_server/route_server ../$build_version/route_server/
    cp route_server/routeserver.conf ../$build_version/route_server/
    cp slog/log4cxx.properties ../$build_version/route_server/
    cp slog/libslog.so ../$build_version/route_server/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/route_server/
    cp monitor.sh ../$build_version/route_server/

    cp msg_server/msg_server ../$build_version/msg_server/
    cp msg_server/msgserver.conf ../$build_version/msg_server/
    cp slog/log4cxx.properties ../$build_version/msg_server/
    cp slog/libslog.so ../$build_version/msg_server/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/msg_server/
    cp monitor.sh ../$build_version/msg_server/
    ...
    cp slog/log4cxx.properties ../$build_version/http_msg_server/
    cp slog/libslog.so ../$build_version/http_msg_server/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/http_msg_server/
    cp monitor.sh ../$build_version/http_msg_server/

    cp file_server/file_server ../$build_version/file_server/
    cp file_server/fileserver.conf ../$build_version/file_server/
    cp slog/log4cxx.properties ../$build_version/file_server/
    cp slog/libslog.so ../$build_version/file_server/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/file_server/
    cp monitor.sh ../$build_version/file_server/

    cp push_server/push_server ../$build_version/push_server/
    cp push_server/pushserver.conf ../$build_version/push_server/
    cp slog/log4cxx.properties ../$build_version/push_server/
    cp slog/libslog.so ../$build_version/push_server/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/push_server/
    cp monitor.sh ../$build_version/push_server/
    ...
    cp slog/log4cxx.properties ../$build_version/db_proxy_server/
    cp slog/libslog.so ../$build_version/db_proxy_server/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/db_proxy_server/
    cp monitor.sh ../$build_version/db_proxy_server/

    cp msfs/msfs ../$build_version/msfs/
    cp msfs/msfs.conf ../$build_version/msfs/
    cp slog/log4cxx.properties ../$build_version/msfs/
    cp slog/libslog.so ../$build_version/msfs/
    cp -a slog/lib/liblog4cxx.so* ../$build_version/msfs/
    cp monitor.sh ../$build_version/msfs/
