...
inline std::string* IMMsgServRsp::release_prior_ip() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return prior_ip_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* IMMsgServRsp::release_backip_ip() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return backip_ip_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
