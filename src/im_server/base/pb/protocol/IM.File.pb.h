...
class IMFileLoginReq final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileLoginReq) */ {
 public:
...
class IMFileLoginRsp final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileLoginRsp) */ {
 public:
...
class IMFileState final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileState) */ {
 public:
...
class IMFilePullDataReq final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFilePullDataReq) */ {
 public:
...
class IMFilePullDataRsp final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFilePullDataRsp) */ {
 public:
...
class IMFileReq final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileReq) */ {
 public:
...
class IMFileRsp final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileRsp) */ {
 public:
...
class IMFileNotify final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileNotify) */ {
 public:
...
class IMFileHasOfflineReq final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileHasOfflineReq) */ {
 public:
...
class IMFileHasOfflineRsp final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileHasOfflineRsp) */ {
 public:
...
class IMFileAddOfflineReq final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileAddOfflineReq) */ {
 public:
...
class IMFileDelOfflineReq final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:IM.File.IMFileDelOfflineReq) */ {
 public:
...
inline const std::string& IMFilePullDataRsp::_internal_data() const {
  return data_.Get();
}
...
// optional bytes attach_data = 20;
inline bool IMFileHasOfflineReq::_internal_has_attach_data() const {
...
// optional bytes attach_data = 20;
inline bool IMFileHasOfflineRsp::_internal_has_attach_data() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
