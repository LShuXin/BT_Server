...
class IMHeartBeat extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IMHeartBeat', package: const $pb.PackageName(_omitMessageNames ? '' : 'IM.Other'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  IMHeartBeat copyWith(void Function(IMHeartBeat) updates) => super.copyWith((message) => updates(message as IMHeartBeat)) as IMHeartBeat;
  ...
  @$core.pragma('dart2js:noInline')
  static IMHeartBeat getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IMHeartBeat>(create);
