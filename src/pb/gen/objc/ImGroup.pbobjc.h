 ...
 **/
GPB_FINAL @interface ImGroupRoot : GPBRootObject
@end
...
GPB_FINAL @interface IMNormalGroupListReq : GPBMessage
...
GPB_FINAL @interface IMNormalGroupListRsp : GPBMessage
...
GPB_FINAL @interface IMGroupInfoListReq : GPBMessage
...
GPB_FINAL @interface IMGroupInfoListRsp : GPBMessage
...
GPB_FINAL @interface IMGroupCreateReq : GPBMessage
...
GPB_FINAL @interface IMGroupCreateRsp : GPBMessage
...
GPB_FINAL @interface IMGroupChangeMemberReq : GPBMessage
...
GPB_FINAL @interface IMGroupChangeMemberRsp : GPBMessage
...
GPB_FINAL @interface IMGroupShieldReq : GPBMessage
...
GPB_FINAL @interface IMGroupShieldRsp : GPBMessage
...
GPB_FINAL @interface IMGroupChangeMemberNotify : GPBMessage
