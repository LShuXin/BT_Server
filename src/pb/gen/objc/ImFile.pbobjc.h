 ...
 **/
GPB_FINAL @interface ImFileRoot : GPBRootObject
@end
...
GPB_FINAL @interface IMFileLoginReq : GPBMessage
...
GPB_FINAL @interface IMFileLoginRsp : GPBMessage
...
GPB_FINAL @interface IMFileState : GPBMessage
...
GPB_FINAL @interface IMFilePullDataReq : GPBMessage
...
typedef GPB_ENUM(IMFilePullDataRsp_FieldNumber) {
  ...
  IMFilePullDataRsp_FieldNumber_Data_p = 5,
};

GPB_FINAL @interface IMFilePullDataRsp : GPBMessage
...
GPB_FINAL @interface IMFileReq : GPBMessage
...
GPB_FINAL @interface IMFileRsp : GPBMessage
...
GPB_FINAL @interface IMFileNotify : GPBMessage
...
GPB_FINAL @interface IMFileHasOfflineReq : GPBMessage
...
GPB_FINAL @interface IMFileHasOfflineRsp : GPBMessage
...
GPB_FINAL @interface IMFileAddOfflineReq : GPBMessage
...
GPB_FINAL @interface IMFileDelOfflineReq : GPBMessage
