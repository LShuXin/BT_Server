...
typedef GPB_ENUM(InternalCmdID) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  InternalCmdID_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  InternalCmdID_CidInternalNone = 0,

  /** 同步认证信息请求 */
  InternalCmdID_CidInternalSyncAuthInfoReq = 2049,

  /** 同步认证信息响应 */
  InternalCmdID_CidInternalSyncAuthInfoRsp = 2050,

  /** nick 换 userId 请求 */
  InternalCmdID_CidInternalUserIdByNickNameReq = 2051,

  /** nick 换 userId 响应 */
  InternalCmdID_CidInternalUserIdByNickNameRsp = 2052,
};
 ...
 * the time this source was generated.
 **/
BOOL InternalCmdID_IsValidValue(int32_t value);
...
typedef GPB_ENUM(BuddyListCmdID) {
  ...
  BuddyListCmdID_CidBuddyListNone = 0,
...
typedef GPB_ENUM(SwitchServiceCmdID) {
  ...
  SwitchServiceCmdID_CidSwitchNone = 0,
...
typedef GPB_ENUM(KickReasonType) {
  ...
  KickReasonType_KickReasonNone = 0,
...
typedef GPB_ENUM(OnlineListType) {
  ...
  OnlineListType_OnlineListTypeNone = 0,
...
typedef GPB_ENUM(GroupModifyType) {
  ...
  GroupModifyType_GroupModifyNone = 0,
...
typedef GPB_ENUM(ClientFileRole) {
  ...
  ClientFileRole_ClientRealtimeNone = 0,
 ...
 **/
GPB_FINAL @interface ImBaseDefineRoot : GPBRootObject
@end
...
GPB_FINAL @interface IpAddr : GPBMessage
...
GPB_FINAL @interface ContactSessionInfo : GPBMessage
...
GPB_FINAL @interface UserStat : GPBMessage
...
GPB_FINAL @interface ServerUserStat : GPBMessage
...
GPB_FINAL @interface UnreadInfo : GPBMessage
...
GPB_FINAL @interface MsgInfo : GPBMessage
...
GPB_FINAL @interface GroupVersionInfo : GPBMessage
...
GPB_FINAL @interface UserTokenInfo : GPBMessage
...
GPB_FINAL @interface ShieldStatus : GPBMessage
...
GPB_FINAL @interface OfflineFileInfo : GPBMessage
...
typedef GPB_ENUM(AuthInfo_FieldNumber) {
  AuthInfo_FieldNumber_AppKey = 1,
  AuthInfo_FieldNumber_UserId = 2,
  AuthInfo_FieldNumber_AllowdUserIds = 3,
  AuthInfo_FieldNumber_AllowdGroupIds = 4,
  AuthInfo_FieldNumber_AuthInterfaces = 5,
  AuthInfo_FieldNumber_AuthIps = 6,
};
...
@property(nonatomic, readwrite, copy, null_resettable) NSString *allowdUserIds;

@property(nonatomic, readwrite, copy, null_resettable) NSString *allowdGroupIds;

@property(nonatomic, readwrite, copy, null_resettable) NSString *authInterfaces;

@property(nonatomic, readwrite, copy, null_resettable) NSString *authIps;
...
GPB_FINAL @interface DepartInfo : GPBMessage
...
GPB_FINAL @interface PushShieldStatus : GPBMessage
