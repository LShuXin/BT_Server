 ...
 * service id  0x0003
 **/
GPB_FINAL @interface IMMsgData : GPBMessage
...
GPB_FINAL @interface IMMsgDataAck : GPBMessage
...
GPB_FINAL @interface IMMsgDataReadAck : GPBMessage
...
GPB_FINAL @interface IMMsgDataReadNotify : GPBMessage
 ...
 * cmd id:        0x0305
 **/
GPB_FINAL @interface IMClientTimeReq : GPBMessage
...
GPB_FINAL @interface IMClientTimeRsp : GPBMessage
...
GPB_FINAL @interface IMUnreadMsgCntReq : GPBMessage
...
GPB_FINAL @interface IMUnreadMsgCntRsp : GPBMessage
...
GPB_FINAL @interface IMGetMsgListReq : GPBMessage
 ...
 * 客户端做一个缺失标记，避免下次再次拉取。
 **/
GPB_FINAL @interface IMGetMsgListRsp : GPBMessage
...
GPB_FINAL @interface IMGetLatestMsgIdReq : GPBMessage
...
GPB_FINAL @interface IMGetLatestMsgIdRsp : GPBMessage
...
GPB_FINAL @interface IMGetMsgByIdReq : GPBMessage
...
GPB_FINAL @interface IMGetMsgByIdRsp : GPBMessage
