...
GPB_FINAL @interface IMAvatarChangedNotify : GPBMessage
...
GPB_FINAL @interface IMChangeSignInfoReq : GPBMessage
...
GPB_FINAL @interface IMChangeSignInfoRsp : GPBMessage
 ...
 * 个性签名修改通知（广播）
 **/
GPB_FINAL @interface IMSignInfoChangedNotify : GPBMessage
